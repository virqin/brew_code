...
ARM_HOME       =$(ARMHOME)
TARGET         =capture
OBJS           =AEEBase.o capture.o widget_stubs.o xmodimpl.o xmodstub.o scs.o
APP_INCLUDES   = -I "$(BUITDIR)\widgets\inc" -I "$(BUITDIR)\framewidget\inc" -I "$(BUITDIR)\xmod" -I "$(BREWDIR)/inc" -I "$(BREWDIR)/sdk/inc"
...
OPT = -Ospace -O2 -E     # Full compiler optimization for space
...
aeebase.o:	aeebase.c
capture.o:	capture.c
capture.o:	inc\capture.bid
capture.o:	inc\capture_res.h
widget_stubs.o:	widget_stubs.c
xmodimpl.o:	xmod\xmodimpl.c
xmodimpl.o:	xmod\xmod.h
xmodstub.o:	xmod\xmodstub.c
xmodstub.o:	xmod\xmod.h
