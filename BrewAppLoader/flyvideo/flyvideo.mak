...
TARGET         = flyvideo
OBJS           = AEEMOD~1.o MAINAP~1.o AEEAPP~1.o AEEMED~1.o BFF-AP~1.o BFF-AP~2.o BFF-DI~1.o BFF-HA~1.o BFF-LO~1.o bff-mem.o BFF-SC~1.o BFF-ST~1.o BFFIM-~1.o BFFIM-~2.o BFFIM-~3.o SCENEU~1.o SOURCE~1.o MAINSC~1.o MAINTA~1.o SCENEC~1.o TESTSC~1.o UI_DIA~1.o GCCResolver.o 
APP_INCLUDES   = -I "$(BREWDIR)\inc"-I $(BREWDIR)\inc -I inc -I inc\framework
...
#-----------------------------------------------------------------------
INC	=	-I$(AEEINCPATH) -I$(GCC_LIBPATH)\include -I$(GCC_HOME)\arm-elf\include -I inc -I inc\framework
...
RULE2 = c:\BREWAP~1\flyvideo\src\FRAMEW~1
{$(RULE2)}.c.o:
	@echo ---------------------------------------------------------------
	@echo OBJECT $(@F)
...
RULE3 = c:\BREWAP~1\flyvideo\src\FRAMEW~1\bff
{$(RULE3)}.c.o:
	@echo ---------------------------------------------------------------
	@echo OBJECT $(@F)
	$(GCC) $(CFLAGS) $(INC) $(OBJ_FILE)  $(RULE3)\$(SRC_FILE)
	@echo ---------------------------------------------------------------


RULE4 = c:\BREWAP~1\flyvideo\src\FRAMEW~1\bffim
{$(RULE4)}.c.o:
	@echo ---------------------------------------------------------------
	@echo OBJECT $(@F)
	$(GCC) $(CFLAGS) $(INC) $(OBJ_FILE)  $(RULE4)\$(SRC_FILE)
	@echo ---------------------------------------------------------------
