   ...
   case IDL_INCOM_OPTIONS_BUSY:    
     {
       ...
       QSR_DIALER_MSG( 2854952332ULL, "Sent: 0 SEND", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
       ShowBusyIcon(pMe->a.m_pIShell, pMe->a.m_pIDisplay, &pMe->m_rc, FALSE);
       return TRUE;
     }
   ...
   case IDL_INCOM_OPTIONS_ENDACTIVE:
     {
       ...
       QSR_DIALER_MSG( 3064050931ULL, "Sent: 1 SEND", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
       ShowBusyIcon(pMe->a.m_pIShell, pMe->a.m_pIDisplay, &pMe->m_rc, FALSE);
       return TRUE;
     }
   ...
   case IDL_INCOM_OPTIONS_SWAP:    
      {
       ...
       QSR_DIALER_MSG( 1368807697ULL, "Sent: 2 SEND", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
       ShowBusyIcon(pMe->a.m_pIShell, pMe->a.m_pIDisplay, &pMe->m_rc, FALSE);
       return TRUE;
     }
   ...
   case IDL_INCOM_OPTIONS_TRANSFER:    
     {
       ...
       QSR_DIALER_MSG( 3732528443ULL, "Sent: 4 SEND", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
       ShowBusyIcon(pMe->a.m_pIShell, pMe->a.m_pIDisplay, &pMe->m_rc, FALSE);
       return TRUE;
     }
...
static boolean CDialerApp_ForwardingDlg_Forward(CDialerApp *pMe)
{
  ...
  QSR_DIALER_MSG( 1487205315ULL, "Sent: 4*<number> SEND", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
