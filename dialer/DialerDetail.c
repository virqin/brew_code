...
#error code not present
  ...
  default:
    QSR_DIALER_MSG( 3894831899ULL, "Invalid Call State for Detail Dlg", 0,0,0);//auto-gen, to change remove 'QSR_' and first param
    FREEIF(pszTimeBuf);
    FREEIF(pszNumberBuf);
    FREEIF(pszName);
    FREEIF(pszCUGBuf);
   ...
   case IDL_CALL_OPTIONS_ENDHELD:
     {
       ...
       QSR_DIALER_MSG( 2327474043ULL, "Sent: 0 SEND", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
       ShowBusyIcon(pMe->a.m_pIShell, pMe->a.m_pIDisplay, &pMe->m_rc, FALSE);
       return TRUE;
     }
   ...
   case IDL_CALL_OPTIONS_ENDACTIVE:
     {
       ...
       QSR_DIALER_MSG( 1623167564ULL, "Sent: 1 SEND", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
       ShowBusyIcon(pMe->a.m_pIShell, pMe->a.m_pIDisplay, &pMe->m_rc, FALSE);
       return TRUE;
     }
   ...
   case IDL_CALL_OPTIONS_HOLD:
     {
       ...
       QSR_DIALER_MSG( 3478304920ULL, "Sent: 2 SEND", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
       ShowBusyIcon(pMe->a.m_pIShell, pMe->a.m_pIDisplay, &pMe->m_rc, FALSE);
       return TRUE;
     }
   ...
   case IDL_CALL_OPTIONS_PRIVATECALL:
     {
       ...
       QSR_DIALER_MSG( 3971842790ULL, "Sent: 2 %d SEND", pMe->m_byCurrCallOptions, 0, 0);//auto-gen, to change remove 'QSR_' and first param
       ShowBusyIcon(pMe->a.m_pIShell, pMe->a.m_pIDisplay, &pMe->m_rc, FALSE);
       return TRUE;
     }
   ...
   case IDL_CALL_OPTIONS_CONFERENCE:
     {
       ...
       QSR_DIALER_MSG( 199653783ULL, "Sent: 3 SEND", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
       ShowBusyIcon(pMe->a.m_pIShell, pMe->a.m_pIDisplay, &pMe->m_rc, FALSE);
       return TRUE;
     }
   ...
   case IDL_CALL_OPTIONS_TRANSFER:
     {
       ...
       QSR_DIALER_MSG( 2387689878ULL, "Sent: 4 SEND", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
       ShowBusyIcon(pMe->a.m_pIShell, pMe->a.m_pIDisplay, &pMe->m_rc, FALSE);
       return TRUE;
     }
