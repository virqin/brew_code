...
static void CDialerApp_SetDisplayPower(CDialerApp *pMe, int nOnOff)
{
  ...
  if (!pMe)
  {
    QSR_MSG_ERROR( 4029727024ULL, "NULL pMe.", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
    return;
  }
  ...
  else
  {
    ...
    do
    {
      ...
      if (nReturnStatus != SUCCESS)
      {
         ...
         * clamshell open.
         */
        QSR_MSG_MED( 1028827336ULL, "Unable to get clamshell status: %d.", nReturnStatus, 0, 0);//auto-gen, to change remove 'QSR_' and first param
        bIsFlipOpen = TRUE;
      }
          ...
          )
      {
        ...
        {
          QSR_MSG_MED( 599445080ULL, "Unable to get primary display bitmap.", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
          break;
        }
        ...
        {
          QSR_MSG_MED( 3639297966ULL, "Unable to get bmp info.", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
          break;
        }
      }
      else
      {
        ...
        {
          QSR_MSG_MED( 1305798585ULL, "Unable to create secondary display.", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
          break;
        }
        ...
        if ((SUCCESS != nReturnStatus) || (!pIBitmap))
        {
          QSR_MSG_MED( 1317569096ULL, "Unable to get secondary display bitmap.", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
          break;
        }
      ...
      {
        QSR_MSG_MED( 826857348ULL, "Unable to create annunciator, %d.", nReturnStatus, 0, 0);//auto-gen, to change remove 'QSR_' and first param
        break;
      }
      else
      {
        ...
        {
          QSR_MSG_MED( 3905257400ULL, "Unable to update annunciator.", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
        }
      }
...
***************************************************************/
    if (((AEENotify *) dwParam)->cls == AEECLSID_ALERT_NOTIFIER)
    {
      ...
      case NMASK_ALERT_ONOFF: 
        QSR_DIALER_MSG( 109326299ULL, "NMASK_ALERT_ONOFF", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
      ...
      case NMASK_ALERT_MUTED:
        QSR_DIALER_MSG( 4154212580ULL, "NMASK_ALERT_MUTED", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
        return TRUE;

      default:
        QSR_DIALER_MSG( 3989558525ULL, "IALERT mask %d Not Handled", wParam, 0, 0);//auto-gen, to change remove 'QSR_' and first param
        return FALSE;
      }
    }
...
***************************************************************/
    if (((AEENotify *) dwParam)->cls == AEECLSID_CM_NOTIFIER)
    {
      ...
      case AEECM_EVENT_CALL_ORIG:
        QSR_DIALER_MSG( 2609408586ULL, "AEECM_EVENT_CALL_ORIG", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
        ...
        if (EventInfo->event_data.call.call_info.call_type ==
            AEECM_CALL_TYPE_SMS)
        {
          QSR_DIALER_MSG( 2676986810ULL, "Ignoring SMS call.", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
          return FALSE;
        }
      ...
      case AEECM_EVENT_CALL_ALL_CALLS_ENDED:
        QSR_DIALER_MSG( 2569022864ULL, "AEECM_EVENT_CALL_ALL_CALLS_ENDED", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
        return TRUE;
      ...
      case AEECM_EVENT_CALL_END:
        {
          ...
          QSR_DIALER_MSG( 1824926607ULL, "AEECM_EVENT_CALL_END", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
          ...
          if ((nReturnStatus == SUCCESS) && (pIConfig != NULL))
          {
             ...
             if (nReturnStatus != SUCCESS)
             {
                QSR_MSG_LOW( 1815692206ULL, "Failed to get in-call display setting, %d.",
                        nReturnStatus, 0, 0);//auto-gen, to change remove 'QSR_' and first param
      ...
      case AEECM_EVENT_CALL_INCOM:
        {
          ...
          QSR_DIALER_MSG( 2814910451ULL, "AEECM_EVENT_CALL_INCOM", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
      ...
      case AEECM_EVENT_CALL_CONNECT:
        {
          ...
          QSR_DIALER_MSG( 162594690ULL, "AEECM_EVENT_CALL_CONNECT", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
          ...
          {
            QSR_MSG_LOW( 2539403238ULL, "Turning off displays while in call.", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
...
#error code not present
      ...
      case AEECM_EVENT_CALL_ERROR:     
        QSR_DIALER_MSG( 1356557613ULL, "AEECM_EVENT_CALL_ERROR: %d", EventInfo->event_data.call.call_error, 0, 0); //auto-gen, to change remove 'QSR_' and first param
        (void) CDialerApp_EndDlgEx(pMe, IDD_NUMEDIT);
      ...
      case AEECM_CALL_EVENT_NSS_REL_REC:     
        QSR_DIALER_MSG( 4068770760ULL, "AEECM_CALL_EVENT_NSS_REL_REC CallId: %d", EventInfo->event_data.call.call_id, 0, 0); //auto-gen, to change remove 'QSR_' and first param
        return (CDialerApp_HandleNSSRelRecord(pMe, EventInfo->event_data.call.call_id));

       case AEECM_EVENT_CALL_OPS_ERROR:
         QSR_DIALER_MSG( 1757478899ULL, "AEECM_EVENT_CALL_OPS_ERROR: %d", EventInfo->event_data.call.callops_error, 0, 0);//auto-gen, to change remove 'QSR_' and first param
       ...
       case AEECM_EVENT_CALL_OPS:         
         QSR_DIALER_MSG( 3234645271ULL, "AEECM_EVENT_CALL_OPS", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
       ...
       case AEECM_EVENT_CALL_CALLER_ID:     /* Caller ID info was received from BS */
         QSR_DIALER_MSG( 943691105ULL, "AEECM_EVENT_CALL_CALLER_ID", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
       ...
       case AEECM_EVENT_CALL_BARRED:         // call barred notification */
         QSR_DIALER_MSG( 2364993115ULL, "AEECM_EVENT_CALL_BARRED", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
       ...
       case AEECM_EVENT_CALL_IS_WAITING:     // call is in waiting notification */
         QSR_DIALER_MSG( 157032988ULL, "AEECM_EVENT_CALL_IS_WAITING", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
         CDialerApp_NotifDlg_DisplayMsg(pMe, IDS_CALL_IS_WAITING, 
           DIALERAPP_MIN_DEFAULT_NOTIF_DISPLAY, DIALERAPP_MAX_DEFAULT_NOTIF_DISPLAY);    
         return TRUE;

       case AEECM_EVENT_CALL_ON_HOLD:        // call on hold notification */ 
         QSR_DIALER_MSG( 1472943369ULL, "AEECM_EVENT_CALL_ON_HOLD", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
         return CDialerApp_RefreshDlg(pMe);  
          
       case AEECM_EVENT_CALL_RETRIEVED:      // call retrieved notification */
         QSR_DIALER_MSG( 3611880449ULL, "AEECM_EVENT_CALL_RETRIEVED", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
         return CDialerApp_RefreshDlg(pMe);     
          
       case AEECM_EVENT_CALL_ORIG_FWD_STATUS: // call may be forwarded (to forwarding MS)*/
         QSR_DIALER_MSG( 376739619ULL, "AEECM_EVENT_CALL_ORIG_FWD_STATUS", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
         CDialerApp_NotifDlg_DisplayMsg(pMe, IDS_CALL_FWD_ACTIVE, 
           DIALERAPP_MIN_DEFAULT_NOTIF_DISPLAY, DIALERAPP_MAX_DEFAULT_NOTIF_DISPLAY);
         return TRUE;
          
       case AEECM_EVENT_CALL_FORWARDED:      // call forwarded (to forwarding MS) */
         QSR_DIALER_MSG( 2962216708ULL, "AEECM_EVENT_CALL_FORWARDED", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
       ...
       case AEECM_EVENT_CALL_BEING_FORWARDED:// call being forwarded (to calling MS) */
         QSR_DIALER_MSG( 18046997ULL, "AEECM_EVENT_CALL_BEING_FORWARDED", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
       ...
       case AEECM_EVENT_CALL_INCOM_FWD_CALL: // Incoming forwarded call notification */
         QSR_DIALER_MSG( 2399958960ULL, "AEECM_EVENT_CALL_INCOM_FWD_CALL", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
         CDialerApp_NotifDlg_DisplayMsg(pMe, IDS_FORWARDINCOMINGCALL, 
           DIALERAPP_MIN_DEFAULT_NOTIF_DISPLAY, DIALERAPP_MAX_DEFAULT_NOTIF_DISPLAY);
         return TRUE;
       case AEECM_EVENT_CALL_RESTRICTED: // call restricted notification */    
         QSR_DIALER_MSG( 2983120797ULL, "AEECM_EVENT_CALL_RESTRICTED", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
         CDialerApp_NotifDlg_DisplayMsg(pMe, IDS_CALL_RESTRICTED, 
           DIALERAPP_MIN_DEFAULT_NOTIF_DISPLAY, DIALERAPP_MAX_DEFAULT_NOTIF_DISPLAY);
         return TRUE;

       case AEECM_EVENT_CALL_DEFLECTION:     // Call deflection notification */
         QSR_DIALER_MSG( 3492706221ULL, "AEECM_EVENT_CALL_DEFLECTION", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
         CDialerApp_NotifDlg_DisplayMsg(pMe, IDS_CALL_DEFLECTED, 
           DIALERAPP_MIN_DEFAULT_NOTIF_DISPLAY, DIALERAPP_MAX_DEFAULT_NOTIF_DISPLAY);
         return TRUE;
          
       case AEECM_EVENT_CALL_TRANSFERRED:    // Call transfer notification */
         QSR_DIALER_MSG( 344198695ULL, "AEECM_EVENT_CALL_TRANSFERRED", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
         CDialerApp_NotifDlg_DisplayMsg(pMe, IDS_CALL_TRANSFERRED, 
           DIALERAPP_MIN_DEFAULT_NOTIF_DISPLAY, DIALERAPP_MAX_DEFAULT_NOTIF_DISPLAY);
         return TRUE;

       case AEECM_EVENT_CALL_DISPLAY:        // display info was received from BS. */
         QSR_DIALER_MSG( 3084969139ULL, "AEECM_EVENT_CALL_DISPLAY", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
       ...
       case AEECM_EVENT_CALL_CALLED_PARTY:   // called party info was received from BS. */
         QSR_DIALER_MSG( 103791143ULL, "AEECM_EVENT_CALL_CALLED_PARTY", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
         (void) CDialerApp_RefreshDlg(pMe);
         return TRUE;

       case AEECM_EVENT_CALL_CONNECTED_NUM:  // connected number info was received */
         QSR_DIALER_MSG( 878513113ULL, "AEECM_EVENT_CALL_CONNECTED_NUM", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
         (void) CDialerApp_RefreshDlg(pMe);
         return TRUE;

       case AEECM_EVENT_CALL_CUG_INFO_RECEIVED:   // call forward CUG notification */
         QSR_DIALER_MSG( 140615064ULL, "AEECM_EVENT_CALL_CUG_INFO_RECEIVED", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
         (void) CDialerApp_RefreshDlg(pMe);
         return TRUE;
          
       case AEECM_EVENT_CALL_CNAP_INFO_RECEIVED:  // caller name info notification */
         QSR_DIALER_MSG( 2879368508ULL, "AEECM_EVENT_CALL_CNAP_INFO_RECEIVED", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
         (void) CDialerApp_RefreshDlg(pMe);
         return TRUE;
          
       case AEECM_EVENT_CALL_EMERGENCY_FLASHED:   // voice call converted to emergency */
         QSR_DIALER_MSG( 3973381933ULL, "AEECM_EVENT_CALL_EMERGENCY_FLASHED", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
         (void) CDialerApp_RefreshDlg(pMe);
         return TRUE;
          
       case AEECM_EVENT_CALL_SRV_OPT:        // Service option changed */
         QSR_DIALER_MSG( 1828043937ULL, "AEECM_EVENT_CALL_SRV_OPT", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
         (void) CDialerApp_RefreshDlg(pMe);
         return TRUE;
          
       case AEECM_EVENT_CALL_PRIVACY:           // Privacy mode changed */  
         QSR_DIALER_MSG( 1439153143ULL, "AEECM_EVENT_CALL_PRIVACY", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
         (void) CDialerApp_RefreshDlg(pMe);
         return TRUE;
          
       case AEECM_EVENT_CALL_ENTER_DORMANT:     // for AEECM_CALL_EVENT_RAB_REL_IND ? */
         QSR_DIALER_MSG( 333178868ULL, "AEECM_EVENT_CALL_ENTER_DORMANT", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
         (void) CDialerApp_RefreshDlg(pMe);
         return TRUE;
          
       case AEECM_EVENT_CALL_EXIT_DORMANT:      // for AEECM_CALL_EVENT_RAB_REESTAB_REQ */
         QSR_DIALER_MSG( 1812910856ULL, "AEECM_EVENT_CALL_EXIT_DORMANT", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
         (void) CDialerApp_RefreshDlg(pMe);
         return TRUE;

       case AEECM_EVENT_CALL_SIGNAL:            // signal info was received from BS */
         QSR_DIALER_MSG( 1021647565ULL, "AEECM_EVENT_CALL_SIGNAL", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
       ...
       case AEECM_EVENT_CALL_PROGRESS_INFO_IND: // call origination progress indication */
         QSR_DIALER_MSG( 216012559ULL, "AEECM_EVENT_CALL_PROGRESS_INFO_IND", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
         // set NV var
       ...
       case AEECM_EVENT_CALL_ABRV_ALERT:        // CMDA/AMPS abbreviated alert. */
         QSR_DIALER_MSG( 4202541358ULL, "AEECM_EVENT_CALL_ABRV_ALERT", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
       ...
       case AEECM_EVENT_CALL_ABRV_REORDER:      // AMPS abbreviated reorder. */
         QSR_DIALER_MSG( 3483335430ULL, "AEECM_EVENT_CALL_ABRV_REORDER", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
       ...
       case AEECM_EVENT_CALL_ABRV_INTERCEPT:    // AMPS abbreviated intercept. */
         QSR_DIALER_MSG( 770495179ULL, "AEECM_EVENT_CALL_ABRV_INTERCEPT", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
         CDialerApp_PlayCallFailedSound(pMe, (uint32)AEEALERT_ALERT_ABBR_INTERCEPT);
         return TRUE;

       case AEECM_EVENT_CALL_RECALL_IND:
         QSR_DIALER_MSG( 1066821348ULL, "AEECM_EVENT_CALL_RECALL_IND", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
         {
      ...
      case AEECM_EVENT_CALL_CCBS_ALLOWED:
         QSR_DIALER_MSG( 622716260ULL, "AEECM_EVENT_CALL_CCBS_ALLOWED", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
         {
           CRecallDlgInfo *pDlgInfo;
...
#if defined(FEATURE_WCDMA) || defined (FEATURE_GSM)
        QSR_DIALER_MSG( 2494189397ULL, "AEECM_EVENT_CALL_CCBS_SET", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
      ...
      case AEECM_EVENT_CALL_ANSWER:             // call was answered
        ...
        QSR_DIALER_MSG( 1659729272ULL, "AEECM_EVENT_CALL_ANSWER", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
        return TRUE;

      case AEECM_EVENT_PH_IN_USE_STATE:
        QSR_DIALER_MSG( 978167089ULL, "AEECM_EVENT_PH_IN_USE_STATE", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
#ifdef FEATURE_UI_SECONDARY_DISP_SUPPORT
#error code not present
#endif //FEATURE_UI_SECONDARY_DISP_SUPPORT
        (void) CDialerApp_RefreshDlg(pMe);  
...
***************************************************************/
      ...
      default:
        QSR_DIALER_MSG( 3162111760ULL, "ICM Event %d Not Handled", EventInfo->event, 0, 0);//auto-gen, to change remove 'QSR_' and first param
        return FALSE;
      }
    }
...
***************************************************************/
    ...
    if (((AEENotify *) dwParam)->cls == AEECLSID_SUPPSVC_NOTIFIER)
    {
      ...
      case NMASK_SS_END:
        {  
          QSR_DIALER_MSG( 3773490804ULL, "NMASK_SS_END", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
          ...
          case AEESUPPSVC_EVENT_ERROR:
            QSR_DIALER_MSG( 1883020599ULL, "AEESUPPSVC_EVENT_ERROR", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
          ...
          case AEESUPPSVC_EVENT_RELEASE: 
            QSR_DIALER_MSG( 4136920536ULL, "AEESUPPSVC_EVENT_RELEASE", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
            //CDialerApp_NotifDlg_DisplayMsg(pMe, IDS_PLEASE_TRY_AGAIN, DIALERAPP_MIN_DEFAULT_NOTIF_DISPLAY, DIALERAPP_MAX_DEFAULT_NOTIF_DISPLAY);
            return TRUE;
      ...
      case NMASK_SS_STARTED:
        {
          ...
          QSR_DIALER_MSG( 1457061918ULL, "NMASK_SS_STARTED", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
      ...
      case NMASK_SS_NW_RESPONSE:
        QSR_DIALER_MSG( 2657653762ULL, "NMASK_SS_NW_RESPONSE", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
      ...
      { 
        ...
        QSR_DIALER_MSG( 374599895ULL, "NMASK_SS_NW_INITIATED", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
      ...
      case NMASK_SS_COMPLETE:
        {
          QSR_DIALER_MSG( 2677976553ULL, "NMASK_SS_COMPLETE", 0, 0, 0);   //auto-gen, to change remove 'QSR_' and first param
          ...
          { 
             ...
             case AEESUPPSVC_CC_CAUSE_INFO:
               QSR_DIALER_MSG( 1814162381ULL, "AEESUPPSVC_SS_ERROR_INFO", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
              ...
              case AEESUPPSVC_CALL_BARRING_INFO:
                QSR_DIALER_MSG( 287945482ULL, "AEESUPPSVC_CALL_BARRING_INFO", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
                return CDialerApp_DlgManager_DisplaySSCallBarringInfo(pMe, EventInfo);

              case AEESUPPSVC_FWD_INFO:
                QSR_DIALER_MSG( 964854335ULL, "DialerDlgManager: AEESUPPSVC_FWD_INFO", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
              ...
              case AEESUPPSVC_FWD_FEATURE_LIST_INFO:
                QSR_DIALER_MSG( 3732760854ULL, "AEESUPPSVC_FWD_FEATURE_LIST_INFO", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
                return CDialerApp_DlgManager_DisplaySSForwardingFeatureInfo(pMe, EventInfo);

              case AEESUPPSVC_SS_STATUS_INFO:
                QSR_DIALER_MSG( 3987855861ULL, "AEESUPPSVC_SS_STATUS_INFO", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
                return CDialerApp_DlgManager_DisplaySSStatus(pMe, EventInfo);

              case AEESUPPSVC_CLI_RESTRICTION_INFO:
                QSR_DIALER_MSG( 2885578915ULL, "AEESUPPSVC_CLI_RESTRICTION_INFO", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
                return CDialerApp_DlgManager_DisplaySSCLIRestriction(pMe, EventInfo);
              
              case AEESUPPSVC_CUG_INFO:
                QSR_DIALER_MSG( 3791534148ULL, "AEESUPPSVC_CUG_INFO", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
              ...
              case AEESUPPSVC_BSG_LIST_INFO:
                QSR_DIALER_MSG( 1947707897ULL, "AEESUPPSVC_BSG_LIST_INFO", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
                return CDialerApp_DlgManager_DisplayBSGList(pMe, EventInfo);

              case AEESUPPSVC_USS_DATA_INFO:
                QSR_DIALER_MSG( 3006927549ULL, "AEESUPPSVC_USS_DATA_INFO", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
              ...
              case AEESUPPSVC_USSD_DATA_INFO:
                QSR_DIALER_MSG( 3904633195ULL, "AEESUPPSVC_USSD_DATA_INFO", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
              ...
              case AEESUPPSVC_SS_DATA_INFO:
                QSR_DIALER_MSG( 657853290ULL, "AEESUPPSVC_SS_DATA_INFO", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
              ...
              default:
                ...
                {
                  QSR_DIALER_MSG( 1677340509ULL, "SS SUCCESSFUL", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
                ...
                {
                  QSR_DIALER_MSG( 1485993108ULL, "SS_FAILED", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
      ...
      default:
        QSR_DIALER_MSG( 2449547850ULL, "ISUPPSVC Event %d Not Handled", EventInfo->evt, 0, 0);//auto-gen, to change remove 'QSR_' and first param
        return FALSE;
      }
    }
#endif /* FEATURE_WCDMA || F_GSM */  
    QSR_DIALER_MSG( 1672632931ULL, "EVT_NOTIFY Not Handled: %d", wParam, 0, 0);//auto-gen, to change remove 'QSR_' and first param
    return FALSE;

  default:
    QSR_DIALER_MSG( 807474872ULL, "Event Not Handled: %d", eCode, 0, 0);//auto-gen, to change remove 'QSR_' and first param
    return FALSE;
  } 
}
                              ...
                              AEESUPPSVC_EVENT_DATA *EventInfo )
{
  ...
  if(dwCode == IDS_UNKNOWN) // For Interrogation
  {
    for(i=0; i<(int)pCallBarringInfo->length; i++)
    {
      ...
      {
        QSR_DIALER_MSG( 875004819ULL, "Status Present %d %d %d ",pCallBarringInfo->call_barring_feature_list[i].ss_status.ss_provisioned,  
                                              pCallBarringInfo->call_barring_feature_list[i].ss_status.ss_registered, 
                                              pCallBarringInfo->call_barring_feature_list[i].ss_status.ss_active);//auto-gen, to change remove 'QSR_' and first param
      
        QSR_DIALER_MSG( 127724763ULL, "Status Operative :%d ",pCallBarringInfo->call_barring_feature_list[i].ss_status.ss_operative, 0, 0);//auto-gen, to change remove 'QSR_' and first param
                               ...
                               AEESUPPSVC_EVENT_DATA *EventInfo)
{
  ...
  for(i=0; i<(int)pForwardingInfo->fwd_feature_list.length; i++)
  {
    ...
    if(EventInfo->evt == AEESUPPSVC_EVENT_INTERROGATE_CONF)
    {
      ...
      {
        QSR_DIALER_MSG( 875004819ULL, "Status Present %d %d %d ",pForwardingInfo->fwd_feature_list.fwd_feature[i].ss_status.ss_provisioned,
                                              pForwardingInfo->fwd_feature_list.fwd_feature[i].ss_status.ss_registered,
                                              pForwardingInfo->fwd_feature_list.fwd_feature[i].ss_status.ss_active);//auto-gen, to change remove 'QSR_' and first param

        QSR_DIALER_MSG( 127724763ULL, "Status Operative :%d ",pForwardingInfo->fwd_feature_list.fwd_feature[i].ss_status.ss_operative, 0, 0);//auto-gen, to change remove 'QSR_' and first param
                               ...
                               AEESUPPSVC_EVENT_DATA *EventInfo)
{
  ...
  for(i=0; i<(int)pForwardingInfo->length; i++)
  {
    ...
    if(EventInfo->evt == AEESUPPSVC_EVENT_INTERROGATE_CONF)
    {
      ...
      {
        QSR_DIALER_MSG( 875004819ULL, "Status Present %d %d %d ",pForwardingInfo->fwd_feature[i].ss_status.ss_provisioned,
                                              pForwardingInfo->fwd_feature[i].ss_status.ss_registered,
                                              pForwardingInfo->fwd_feature[i].ss_status.ss_active);//auto-gen, to change remove 'QSR_' and first param

        QSR_DIALER_MSG( 127724763ULL, "Status Operative :%d ",pForwardingInfo->fwd_feature[i].ss_status.ss_operative, 0, 0);//auto-gen, to change remove 'QSR_' and first param
                                   ...
                                   AEESUPPSVC_EVENT_DATA *EventInfo)
{
  ...
  {
    QSR_DIALER_MSG( 875004819ULL, "Status Present %d %d %d ",pCLIInfo->ss_status.ss_provisioned,
                                          pCLIInfo->ss_status.ss_registered,
                                          pCLIInfo->ss_status.ss_active);//auto-gen, to change remove 'QSR_' and first param
  
    QSR_DIALER_MSG( 127724763ULL, "Status Operative :%d ",pCLIInfo->ss_status.ss_operative, 0, 0);//auto-gen, to change remove 'QSR_' and first param
                                                      ...
                                                      AEESUPPSVC_EVENT_DATA *EventInfo)
{
  ...
  if(pStatus->present)
  {
    QSR_DIALER_MSG( 875004819ULL, "Status Present %d %d %d ",pStatus->ss_provisioned,  pStatus->ss_registered, pStatus->ss_active);//auto-gen, to change remove 'QSR_' and first param
                                                   ...
                                                   AEESUPPSVC_EVENT_DATA *EventInfo)
{
  ...
  {
     QSR_DIALER_MSG( 875004819ULL, "Status Present %d %d %d ",pStatusData->ss_status.ss_provisioned,  
                                           pStatusData->ss_status.ss_registered, 
                                           pStatusData->ss_status.ss_active);//auto-gen, to change remove 'QSR_' and first param
     QSR_DIALER_MSG( 127724763ULL, "Status Operative :%d ",pStatusData->ss_status.ss_operative, 0, 0);//auto-gen, to change remove 'QSR_' and first param
                                 ...
                                 AEESUPPSVC_EVENT_DATA *EventInfo)
  {
    ...
    {
      QSR_DIALER_MSG( 875004819ULL, "Status Present %d %d %d ",pCCBSInfo->ss_status.ss_provisioned,
                                           pCCBSInfo->ss_status.ss_registered,
                                           pCCBSInfo->ss_status.ss_active);//auto-gen, to change remove 'QSR_' and first param
  
      QSR_DIALER_MSG( 127724763ULL, "Status Operative :%d ",pCCBSInfo->ss_status.ss_operative, 0, 0);//auto-gen, to change remove 'QSR_' and first param
                                       ...
                                       uint32 dw)
{
  ...
  case EVT_DIALOG_START:
    QSR_DIALER_MSG( 1725507506ULL, "EVT_DIALOG_START %d", pDlgHandlerEntry->wDlgID, 0, 0);//auto-gen, to change remove 'QSR_' and first param
  ...
  case EVT_KEY:
    ...
    {
      QSR_DIALER_MSG( 3748344023ULL, "Handling key event %d, key %d, dialog %d", evt, w, pDlgHandlerEntry->wDlgID);//auto-gen, to change remove 'QSR_' and first param
  ...
  case EVT_COMMAND:
    ...
    {
      QSR_DIALER_MSG( 577189464ULL, "Handling cmd event ctrl_id %d, dialog %d", w, pDlgHandlerEntry->wDlgID, 0);//auto-gen, to change remove 'QSR_' and first param
  ...
  case EVT_DIALOG_END:
    QSR_DIALER_MSG( 2648302052ULL, "EVT_DIALOG_END %d", pDlgHandlerEntry->wDlgID, 0, 0);//auto-gen, to change remove 'QSR_' and first param
