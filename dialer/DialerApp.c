                                      ...
                                      uint32      dwParam)
{
  ...
  case EVT_APP_START:
    {   
      QSR_DIALER_MSG( 2843351394ULL, "EVT_APP_START", 0, 0, 0);   //auto-gen, to change remove 'QSR_' and first param
  ...
  case EVT_APP_STOP:
    {
      ...
      QSR_DIALER_MSG( 1790518147ULL, "EVT_APP_STOP", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
  ...
  case EVT_APP_SUSPEND:
    {
      ...
      QSR_DIALER_MSG( 2259872286ULL, "EVT_APP_SUSPEND", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
  ...
  case EVT_APP_RESUME:
    {
      QSR_DIALER_MSG( 3365383612ULL, "EVT_APP_RESUME", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
  ...
  case EVT_KEY:
    switch(wParam)
    {
      ...
      case AVK_POWER:
        QSR_DIALER_MSG( 1333595113ULL, "AVK_POWER", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
      ...
      case AVK_CLR:
        QSR_DIALER_MSG( 2052168570ULL, "AVK_CLR", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
        // end current dialog
        return CDialerApp_EndDlg(pMe);

      case AVK_END:
        QSR_DIALER_MSG( 977816636ULL, "AVK_END", 0, 0, 0); //auto-gen, to change remove 'QSR_' and first param
        // handle the end key event
        return CDialerApp_HandleEndKey(pMe);

      case AVK_SEND:
        QSR_DIALER_MSG( 2323634003ULL, "AVK_SEND", 0, 0, 0); //auto-gen, to change remove 'QSR_' and first param
  ...
  case EVT_KEY_PRESS:
        {
      QSR_DIALER_MSG( 16087679ULL, "EVT_KEY_PRESS: %d", wParam, 0, 0);//auto-gen, to change remove 'QSR_' and first param
  ...
  case EVT_KEY_RELEASE:
    {
      QSR_DIALER_MSG( 4114466059ULL, "EVT_KEY_RELEASE: %d", wParam, 0, 0);//auto-gen, to change remove 'QSR_' and first param
      switch(pMe->m_LastKeyPressed)
      {
      case '0':
      case '1':
  ...
  case EVT_DIALOG_INIT: 
    {
      ...
      QSR_DIALER_MSG( 803804026ULL, "EVT_DIALOG_INIT", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
  ...
  case EVT_NOTIFY:
    ...
    QSR_DIALER_MSG( 584618333ULL, "EVT_NOTIFY: %d", wParam, 0, 0);//auto-gen, to change remove 'QSR_' and first param
    return CDialerApp_DlgManager(pMe, eCode, wParam, dwParam);

  case EVT_COMMAND:
    {
      QSR_DIALER_MSG( 2072280905ULL, "EVT_COMMAND: %d %d", wParam, dwParam, 0);//auto-gen, to change remove 'QSR_' and first param
      ...
      QSR_DIALER_MSG( 924223350ULL, "EVT_COMMAND: %d %d %d Not Handled", eCode, wParam, dwParam);//auto-gen, to change remove 'QSR_' and first param
      return FALSE;
  ...
  case EVT_USER:
    {
      ...
      QSR_DIALER_MSG( 153978471ULL, "EVT_USER: %d", wParam, 0, 0);//auto-gen, to change remove 'QSR_' and first param
      ...
      case EVT_DIALER_STARTAPP_ICON:
        ...
        QSR_DIALER_MSG( 4071956860ULL, "EVT_DIALER_STARTAPP_ICON", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
        if(pMe->m_bSuspended == FALSE)
        {
          QSR_DIALER_MSG( 4214903460ULL, "Dialer App is already started", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
          return FALSE;
        }
      ...
      case EVT_USB_GENERIC_BUTTON_PRESS:
        QSR_DIALER_MSG( 4080437524ULL, "EVT_USB_GENERIC_BUTTON_PRESS", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
      ...
      case EVT_DIALER_STARTAPP_DIGIT: 
        {
          ...
          QSR_DIALER_MSG( 1292134115ULL, "EVT_DIALER_STARTAPP_DIGIT", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
          if(pMe->m_bSuspended == FALSE)
          {
            QSR_DIALER_MSG( 4214903460ULL, "Dialer App is already started", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
            return FALSE;
      ...
      case EVT_DIALER_STARTAPP_ORIGINATEVOICECALL:
        ...
        QSR_DIALER_MSG( 3121464596ULL, "EVT_DIALER_STARTAPP_ORIGINATEVOICECALL", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
      ...
      case EVT_DIALER_STARTAPP_DISPLAY_STRING:
        QSR_DIALER_MSG( 2161431618ULL, "EVT_DIALER_STARTAPP_DISPLAY_STRING", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
      ...
      case EVT_DIALER_MULTI_COMPLETE:
        ...
        QSR_DIALER_MSG( 2465135149ULL, "EVT_DIALER_MULTI_COMPLETE", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
        uisnd_multi_stop();
        return TRUE;
      ...
      QSR_DIALER_MSG( 4157735683ULL, "EVT_USER: %d Not Handled", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
      return FALSE;
    }
...
#error code not present
    ...
    case EVT_QP_IMS_REGISTRATION:
      ...
      QSR_DIALER_MSG( 974359779ULL, "EVT_QP_IMS_REGISTRATION", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
    ...
    case EVT_QP_IMS_DEREGISTRATION:
      // received an event from the SIP registration manager
      QSR_DIALER_MSG( 3130906316ULL, "EVT_QP_IMS_DEREGISTRATION", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
...
static boolean CDialerApp_OnAppStart(CDialerApp *pMe, uint16 wParam, uint32 dwParam)
{
  ...
  else 
  {
    ...
    QSR_DIALER_MSG( 1684592381ULL, "Dialer will close in 250 ms unless a dialog is created", 0,0,0);//auto-gen, to change remove 'QSR_' and first param
  ...
  if(wNumCallIDs > 0)
  {
    if(bAnswer == TRUE)
    {
      for(i=0; i<wNumCallIDs; i++)
      {
        ...
        {
          QSR_DIALER_MSG( 3078756305ULL, "ANSWER VOICE CALL FAILED - CALLID: %d", CallIDs[i], 0, 0);//auto-gen, to change remove 'QSR_' and first param
          bRetVal = FALSE;
        }
        else
        {
          QSR_DIALER_MSG( 1497168190ULL, "ANSWER VOICE CALL WAS SUCCESSFUL - CALLID: %d", CallIDs[i], 0, 0);//auto-gen, to change remove 'QSR_' and first param
        }
      }
    }
    else
    {
      for(i=0; i<wNumCallIDs; i++)
      {
        ...
        {
          QSR_DIALER_MSG( 3820131329ULL, "REJECT VOICE CALL FAILED - CALLID: %d", CallIDs[i], 0, 0);//auto-gen, to change remove 'QSR_' and first param
          bRetVal = FALSE;
        }
        else
        {
          QSR_DIALER_MSG( 1613629924ULL, "REJECT VOICE CALL WAS SUCCESSFUL - CALLID: %d", CallIDs[i], 0, 0);//auto-gen, to change remove 'QSR_' and first param
        }
      }
    }  
  }
...
boolean CDialerApp_EndVoiceCall(IShell *pIShell)
{
  ...
  if(wNumCallIDs > 0)
  {
    for(i=0; i<wNumCallIDs; i++)
    {
      if(CheckAEEReturnStatus(ICM_EndCall(pICM, CallIDs[i])) == FALSE)
      {
        QSR_DIALER_MSG( 3969958709ULL, "END VOICE CALL FAILED - CALLID: %d", CallIDs[i], 0, 0);//auto-gen, to change remove 'QSR_' and first param
        bRetVal = FALSE;
      }
      else
      {
        QSR_DIALER_MSG( 1165813169ULL, "END VOICE CALL WAS SUCCESSFUL - CALLID: %d", CallIDs[i], 0, 0);//auto-gen, to change remove 'QSR_' and first param
      }
    }
  }
...
boolean CDialerApp_RefreshDlg(void *pUser)
{
  ...
  {	
    QSR_DIALER_MSG( 3213867365ULL, "Cannot refresh dialog because suspended", 0,0,0);//auto-gen, to change remove 'QSR_' and first param
    return TRUE;
  }
