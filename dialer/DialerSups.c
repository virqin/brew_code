...
boolean CDialerApp_SupsCFNRTimerDlgHandler(void *pUser, AEEEvent evt, uint16 wParam, uint32 dwParam)
{
    ...
    case EVT_DIALOG_START:
        QSR_DIALER_MSG( 4191638785ULL, "EVT_DIALOG_START", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
        pIDialog = CDialerApp_GetActiveDlg(pMe);
        if(pIDialog != NULL)
        {
    ...
    case EVT_COMMAND:
        QSR_DIALER_MSG( 692184554ULL, "EVT_COMMAND: %d", wParam, 0, 0);//auto-gen, to change remove 'QSR_' and first param
        pIDialog = CDialerApp_GetActiveDlg(pMe);
    ...
    case EVT_CTL_SEL_CHANGED:       
        QSR_DIALER_MSG( 4222228416ULL, "EVT_CTL_SEL_CHANGED", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
        pIDialog = ISHELL_GetActiveDialog(pMe->a.m_pIShell);
        if(pIDialog != NULL)
        {
    ...
    case EVT_DIALOG_END:
        QSR_DIALER_MSG( 1901256608ULL, "EVT_DIALOG_END", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
        return TRUE;
...
#endif
            QSR_MSG_HIGH( 4000166158ULL, "Text props is 0x%x", textProperties, 0, 0);//auto-gen, to change remove 'QSR_' and first param
