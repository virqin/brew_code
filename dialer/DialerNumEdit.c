...
static void CDialerApp_NumEditDlg_CheckForSS(CDialerApp *pMe)
{
  ...
  case AEESUPPSVC_SS_CMD_STARTED:
    QSR_DIALER_MSG( 888788916ULL, "Supplementary Service Command Successfully Started",0,0,0);//auto-gen, to change remove 'QSR_' and first param
    break;
  ...
  case AEESUPPSVC_SS_FAILED_PINS_DONT_MATCH:
    ...
    QSR_DIALER_MSG( 1775716396ULL, "PINs failed to match",0,0,0);//auto-gen, to change remove 'QSR_' and first param
    break;
  ...
  default:
    ...
    QSR_DIALER_MSG( 348811528ULL, "Supplementary Service Command failed to start %d",nStartSSRetVal,0,0);//auto-gen, to change remove 'QSR_' and first param
    break;
  }
  ...
  case AEESUPPSVC_ILLEGAL_ENTRY:
    QSR_DIALER_MSG( 2861919706ULL, "Illegal entry received for SS String",0,0,0);//auto-gen, to change remove 'QSR_' and first param
  ...
  default:
    QSR_DIALER_MSG( 628692282ULL, "Unknown error %d for SS String",nSSRetVal,0,0);//auto-gen, to change remove 'QSR_' and first param
    (void) ISHELL_LoadResString(pMe->a.m_pIShell,
        DIALERAPP_RES_FILE,
        IDS_SS_START_FAILED,
        pszwErrorMsg,
