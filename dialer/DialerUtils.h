...
#define QSR_DIALER_MSG( xx_hash_val, format, code1, code2, code3)  QSR_MSG_HIGH( xx_hash_val, "", code1, code2, code3)
...
#define QSR_DIALER_MSG( xx_hash_val, format, code1, code2, code3)  QSR_MSG_HIGH( xx_hash_val, "DIALER: " format " " __MODULE__ "(" __MAKESTRING1__(__LINE__) ")", code1, code2, code3)
