...
boolean CDialerApp_StatusDlg_DisplayRefresh(void *pUser)
{
  ...
  QSR_MSG_HIGH( 2525615382ULL, "CDialerApp_StatusDlg_DisplayRefresh: 1", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
                                                   ...
                                                   int16 wMenuWidth)
{
  ...
  PRINT_FUNCTION_NAMEN(1);
  QSR_MSG_HIGH( 3045409848ULL, "CDialerApp_StatusDlg_UpdateMenuItem:", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
...
void CDialerApp_StatusDlg_TimeRefresh(void *pUser)
{
  ...
  {
    QSR_DIALER_MSG( 1084969146ULL, "Do not refresh because of suspend", 0,0,0);//auto-gen, to change remove 'QSR_' and first param
    return;
  }
  ...
  {
    QSR_DIALER_MSG( 574192518ULL, "Do not refresh again - nothing to display", 0, 0, 0);//auto-gen, to change remove 'QSR_' and first param
    (void) ISHELL_CancelTimer(pMe->a.m_pIShell, 
              (PFNNOTIFY) CDialerApp_StatusDlg_TimeRefresh, (void*) pMe);
  }
