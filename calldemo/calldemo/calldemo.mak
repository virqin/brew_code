...
ARM_HOME       =$(ARMHOME)
TARGET         =calldemo
OBJS           =AEEAppGen.o AEEModGen.o calldemo.o 
APP_INCLUDES   = -I "$(BREWDIR)\inc" -I "$(BREWDIR)\sdk\inc"
...
ARMLIB = $(ARM_HOME)\lib\armlib\        # ARM ADS library directory
...
calldemo.o:	calldemo.c
calldemo.o:	calldemo.bid
calldemo.o:	calldemo.h
calldemo.o:	calldemo.brh
